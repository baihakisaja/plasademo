                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5 mt-3">
                                    ...
                                    src="<?php echo base_url();?>assets/images/sorry.jpg" alt="Logo">
                                    <h1 class="h4 text-gray-900 mt-3 mb-4 vp-text">Anda sedang berada di luar jam Operasional</h1>
                                    <hr>
                                    <h3 class="h5 text-gray-900 ">Jam Operasional kami adalah:</h3>
                                    <h4 class="h5 text-gray-800">08:00 - 16:00 WITA</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer p-0">
                        <div class="col-12 p-3">
                            <div class="text-right">
                                <button id="buttonSubmit" class="btn btn-danger">Kembali ke Halaman Utama <i
