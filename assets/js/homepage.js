    ...
    $('.vp-widget').click(function (e) {
        ...
        if (attr_kendala == "pasang-baru") {
            $("#no_hub").append(
                ...
                '<input type="hidden" class="form-control" value="1" name="data_input"><input type="text" class="form-control" name="no_hp" id="no_hp" value="" required="true" onkeypress="return event.charCode >= 48 && event.charCode <= 57">' +
                '</div>'
            );
            ...
            $("#no_hub").append(
                '<div class="form-group">' +
                '<label for="no_hp" class="vp-text">Nomor Handphone / Telepon Rumah</label>' +
                '<input type="hidden" class="form-control" value="3" name="data_input"><input type="text" class="form-control" name="no_hp" id="no_hp" value="" required="true" onkeypress="return event.charCode >= 48 && event.charCode <= 57">' +
                '</div>'
            );
        }else if (attr_kendala == "gangguan") {
            $("#no_hub").append(
                '<div class="form-group">' +
                '<label for="no_indihome" class="vp-text">Nomor XL</label>' +
                '<input type="hidden" class="form-control" value="2" name="data_input"><input type="text" class="form-control" name="no_indihome" id="no_indihome" value="" required="true" onkeypress="return event.charCode >= 48 && event.charCode <= 57">' +
                '</div>'
            );
        } else {
            $("#no_hub").empty();
